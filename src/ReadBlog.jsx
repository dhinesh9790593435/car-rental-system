  ...
  return (
            ...
            <Navbar expand="lg">
              ...
              <Navbar.Collapse id="basic-navbar-nav">
                <Nav id="links" className="me-auto">
                  <Nav.Link as={Link} className="nav-item active" to='/home'>Home</Nav.Link>
   ...
   <div className=' Read-our-blog'>
          <div className=' Read-our-blog-section'>
              <Row>
                   <Col  className='read-blog-text col-lg-8 col-md-8 col-sm-12'>
                   ...
                   <div style={{marginLeft:'0px'}} id='read-btn' className='mt-5'>
                       ...
                       <div className='comments mt-5'>
                         ...
                         <div id='comment'  style={{width:'690px',position:'relative',left:'50px',marginTop:'100px'}}     className='comments mt-5'>
                          <div><img style={{width :'50px',height:'50px',borderRadius:'50%'}}  src={readBlog_person}></img></div>
                          <div>
                             <h4>John Doe</h4>
                             <h6 style={{color:'#007bff',letterSpacing : '1px'}}>Oct. 29, 2019 at 1:21pm</h6>
                         ...
                         <div id='comment-box' style={{width:'649px',position:'relative',left:'100px',marginTop:'100px'}} className='comments mt-5'>
                          <div><img style={{width :'50px',height:'50px',borderRadius:'50%'}}  src={readBlog_person}></img></div>
                          <div>
                             <h4>John Doe</h4>
                             <h6 style={{color:'#007bff',letterSpacing : '1px'}}>Oct. 29, 2019 at 1:21pm</h6>
                        ...
                        <div id='comment-round' style={{width:'600px',position:'relative',left:'160px',marginTop:'100px'}} className='comments mt-5'>
                          <div><img style={{width :'50px',height:'50px',borderRadius:'50%'}}  src={readBlog_person}></img></div>
                          <div>
                             <h4>John Doe</h4>
                             <h6 style={{color:'#007bff',letterSpacing : '1px'}}>Oct. 29, 2019 at 1:21pm</h6>
         ...
         <Col  className='col-lg-4 col-md-4 col-sm-12 form-group-section'>
